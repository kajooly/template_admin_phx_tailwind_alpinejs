defmodule KajoolyTemplateTailwindWeb do
  @moduledoc """
  ...
  This can be used in your application as:
      ...
      use KajoolyTemplateTailwindWeb, :controller
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {KajoolyTemplateTailwindWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import KajoolyTemplateTailwindWeb.LiveHelpers
