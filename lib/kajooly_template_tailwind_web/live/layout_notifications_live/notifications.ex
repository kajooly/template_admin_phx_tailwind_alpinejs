defmodule KajoolyTemplateTailwindWeb.LayoutsLive.Notifications do
  ...
  import KajoolyTemplateTailwindWeb.LayoutNotificationsLive.VerticalNavigationNotifications
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, notifications: notifications(), recent_files: recent_files(), files: files())}
  end
