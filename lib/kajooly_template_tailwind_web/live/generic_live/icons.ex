defmodule KajoolyTemplateTailwindWeb.GenericLive.Icons do
  ...
  def icons_shopping_bag(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg"  id={assigns[:id]||"icons_shopping_bag#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} stroke-width="1.5" stroke="currentColor">
  ...
  def icons_shopping_cart(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg"  id={assigns[:id]||"icons_shopping_cart#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} stroke-width="1.5" stroke="currentColor">
