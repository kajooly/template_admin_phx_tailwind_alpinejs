defmodule KajoolyTemplateTailwindWeb.GenericLive.Icons do
  ...
  def icons_search(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_search#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"currentColor"} class={"bi bi-search #{assigns[:class]}"}>
  ...
  def icons_plus(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_plus#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"currentColor"} class={"bi bi-plus #{assigns[:class]}"}>
