defmodule KajoolyTemplateTailwindWeb.GenericLive.Icons do
  ...
  def icons_bot_1(assigns) do
    ~H"""
      ...
      #{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
      ...
      <g id="2">
        ...
        <path id="Trazado-3" d="M11.316 21.328 C11.039 21.328 10.815 21.105 10.815 20.828 L10.815 18.495 C10.815 18.219 11.039 17.995 11.316 17.995 11.592 17.995 11.816 18.219 11.816 18.495 L11.816 20.828 C11.816 21.105 11.591 21.328 11.316 21.328 Z M11.316 21.328" fill="#000000" fill-opacity="1" stroke="none"/>
        <path id="Trazado-4" d="M20.684 21.314 C20.408 21.314 20.185 21.09 20.185 20.814 L20.185 18.51 C20.185 18.233 20.408 18.01 20.684 18.01 20.961 18.01 21.185 18.233 21.185 18.51 L21.185 20.814 C21.185 21.09 20.961 21.314 20.684 21.314 Z M20.684 21.314" fill="#000000" fill-opacity="1" stroke="none"/>
        <path id="Trazado-5" d="M18.452 25.168 L13.548 25.168 C13.272 25.168 13.048 24.944 13.048 24.668 13.048 24.392 13.272 24.168 13.548 24.168 L18.452 24.168 C18.728 24.168 18.952 24.392 18.952 24.668 18.952 24.944 18.728 25.168 18.452 25.168 Z M18.452 25.168" fill="#000000" fill-opacity="1" stroke="none"/>
        <g id="group-3">
        ...
        <path id="Trazado-10" d="M2.843 17.946 C2.566 17.946 2.343 17.722 2.343 17.446 L2.343 10.795 C2.343 10.518 2.566 10.294 2.843 10.294 3.119 10.294 3.343 10.518 3.343 10.795 L3.343 17.446 C3.343 17.722 3.119 17.946 2.843 17.946 Z M2.843 17.946" fill="#000000" fill-opacity="1" stroke="none"/>
  ...
  def icons_bot_2(assigns) do
    ~H"""
      ...
      #{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} stroke-width="1.5" viewBox="0 0 24 24" stroke="currentColor"  viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
        <!-- Generated by Pixelmator Pro 2.1.3 -->
        <g id="1">
          ...
          <path id="Trazado-1" d="M15.198 3.961 L16.765 3.961 16.765 8.717 15.198 8.717 Z M15.198 3.961" fill="#000000" fill-opacity="1" stroke="none"/>
          <path id="Trazado-2" d="M15.981 1.799 C17.115 1.799 18.035 2.719 18.035 3.853 18.035 4.987 17.115 5.907 15.981 5.907 14.847 5.907 13.927 4.987 13.927 3.853 13.927 2.719 14.847 1.799 15.981 1.799 Z M15.981 1.799" fill="#000000" fill-opacity="1" stroke="none"/>
          <g id="group">
          <path id="Trazado-3" d="M2.741 19.457 C1.227 19.457 0 18.229 0 16.716 0 15.203 1.227 13.975 2.741 13.975 Z M2.741 19.457" fill="#000000" fill-opacity="1" stroke="none"/>
          </g>
          <path id="Trazado-4" d="M29.26 19.457 C30.773 19.457 32 18.229 32 16.716 32 15.203 30.773 13.975 29.26 13.975 Z M29.26 19.457" fill="#000000" fill-opacity="1" stroke="none"/>
          <path id="Trazado-5" d="M12.226 13.436 C12.896 13.436 13.444 13.984 13.444 14.654 L13.444 18.343 C13.444 19.013 12.896 19.561 12.226 19.561 11.556 19.561 11.007 19.013 11.007 18.343 L11.007 14.654 C11.007 13.984 11.556 13.436 12.226 13.436 Z M12.226 13.436" fill="#000000" fill-opacity="1" stroke="none"/>
