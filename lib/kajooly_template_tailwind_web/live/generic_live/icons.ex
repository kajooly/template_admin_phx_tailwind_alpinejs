defmodule KajoolyTemplateTailwindWeb.GenericLive.Icons do
  ...
  def icons_arrow_path(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg"  id={assigns[:id]||"icons_arrow_path#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 24 24" stroke-width="1.5" stroke={assigns[:stroke]||"currentColor"}>
        <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
      </svg>
    """
  end
  def icons_map(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_map#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 24 24" stroke-width="1.5" stroke={assigns[:stroke]||"currentColor"}>
        <path stroke-linecap="round" stroke-linejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498l4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 00-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0z" />
      </svg>
    """
  end
  def icons_map_pin(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_map_pin#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 24 24" stroke-width="1.5" stroke={assigns[:stroke]||"currentColor"}>
        <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
      </svg>
    """
  end
  def icons_paw(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_paw#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 512 512" stroke={assigns[:stroke]||"currentColor"}><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M226.5 92.9c14.3 42.9-.3 86.2-32.6 96.8s-70.1-15.6-84.4-58.5s.3-86.2 32.6-96.8s70.1 15.6 84.4 58.5zM100.4 198.6c18.9 32.4 14.3 70.1-10.2 84.1s-59.7-.9-78.5-33.3S-2.7 179.3 21.8 165.3s59.7 .9 78.5 33.3zM69.2 401.2C121.6 259.9 214.7 224 256 224s134.4 35.9 186.8 177.2c3.6 9.7 5.2 20.1 5.2 30.5v1.6c0 25.8-20.9 46.7-46.7 46.7c-11.5 0-22.9-1.4-34-4.2l-88-22c-15.3-3.8-31.3-3.8-46.6 0l-88 22c-11.1 2.8-22.5 4.2-34 4.2C84.9 480 64 459.1 64 433.3v-1.6c0-10.4 1.6-20.8 5.2-30.5zM421.8 282.7c-24.5-14-29.1-51.7-10.2-84.1s54-47.3 78.5-33.3s29.1 51.7 10.2 84.1s-54 47.3-78.5 33.3zM310.1 189.7c-32.3-10.6-46.9-53.9-32.6-96.8s52.1-69.1 84.4-58.5s46.9 53.9 32.6 96.8s-52.1 69.1-84.4 58.5z"/></svg>
    """
  end
  def icons_lifebuoy(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_lifebuoy#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
  ...
  def icons_bulb(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_bulb#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />
      </svg>
    """
  end
  def icons_tv(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_tv#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="M6 20.25h12m-7.5-3v3m3-3v3m-10.125-3h17.25c.621 0 1.125-.504 1.125-1.125V4.875c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125z" />
      </svg>
    """
  end
  def icons_wind(assigns) do
    ~H"""
     <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_wind#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 20 14">
  ...
  def icons_camara(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_camara#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" />
        <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM18.75 10.5h.008v.008h-.008V10.5z" />
      </svg>
    """
  end
  def icons_video_camara(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_video_camara#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        <path stroke-linecap="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" />
      </svg>
    """
  end
  def icons_shopping_bag(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg"  id={assigns[:id]||"icons_shopping_bag#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} stroke-width="1.5" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
      </svg>
    """
  end
  def icons_shopping_cart(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg"  id={assigns[:id]||"icons_shopping_cart#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} stroke-width="1.5" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
      </svg>

    """
  end
  def icons_bot_1(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_bot_1
      #{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} stroke-width="1.5" viewBox="0 0 24 24" stroke="currentColor" zoomAndPan="magnify" viewBox="0 0 375 374.999991" preserveAspectRatio="xMidYMid meet" version="1.0"><defs><clipPath id="b5a96619a6"><path d="M 13.253906 149 L 44 149 L 44 210 L 13.253906 210 Z M 13.253906 149 " clip-rule="nonzero"/></clipPath></defs><path fill="#000000" d="M 136.78125 78.496094 L 237.816406 78.496094 C 265.589844 78.496094 290.828125 89.855469 309.125 108.148438 C 327.410156 126.433594 338.769531 151.683594 338.769531 179.457031 C 338.769531 207.230469 327.410156 232.476562 309.125 250.765625 C 290.828125 269.058594 265.589844 280.410156 237.816406 280.410156 L 226.785156 280.410156 L 170.734375 332.644531 C 165.667969 337.351562 157.742188 337.066406 153.027344 332.007812 C 150.78125 329.589844 149.667969 326.527344 149.667969 323.46875 L 149.644531 323.46875 L 149.644531 280.410156 L 136.78125 280.410156 C 109.007812 280.410156 83.769531 269.058594 65.472656 250.765625 C 47.179688 232.476562 35.828125 207.230469 35.828125 179.457031 C 35.828125 151.683594 47.179688 126.433594 65.472656 108.148438 C 83.769531 89.855469 109.007812 78.496094 136.78125 78.496094 Z M 237.816406 103.613281 L 136.78125 103.613281 C 115.9375 103.613281 96.980469 112.152344 83.230469 125.902344 C 69.476562 139.648438 60.941406 158.613281 60.941406 179.457031 C 60.941406 200.300781 69.476562 219.257812 83.230469 233.007812 C 96.980469 246.761719 115.9375 255.300781 136.78125 255.300781 L 162.195312 255.300781 C 169.132812 255.300781 174.753906 260.921875 174.753906 267.859375 L 174.753906 294.644531 L 212.730469 259.246094 C 215.027344 256.820312 218.273438 255.300781 221.882812 255.300781 L 237.816406 255.300781 C 258.652344 255.300781 277.617188 246.761719 291.371094 233.007812 C 305.113281 219.257812 313.652344 200.300781 313.652344 179.457031 C 313.652344 158.613281 305.113281 139.648438 291.371094 125.902344 C 277.617188 112.152344 258.652344 103.613281 237.816406 103.613281 Z M 237.816406 103.613281 " fill-opacity="1" fill-rule="nonzero"/><path fill="#000000" d="M 178.765625 40.542969 L 195.835938 40.542969 L 195.835938 92.347656 L 178.765625 92.347656 Z M 178.765625 40.542969 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 187.296875 17 C 199.648438 17 209.667969 27.019531 209.667969 39.367188 C 209.667969 51.71875 199.648438 61.738281 187.296875 61.738281 C 174.949219 61.738281 164.929688 51.71875 164.929688 39.367188 C 164.929688 27.019531 174.949219 17 187.296875 17 Z M 187.296875 17 " fill-opacity="1" fill-rule="evenodd"/><g clip-path="url(#b5a96619a6)"><path fill="#000000" d="M 43.101562 209.304688 C 26.613281 209.304688 13.253906 195.9375 13.253906 179.457031 C 13.253906 162.976562 26.613281 149.609375 43.101562 149.609375 Z M 43.101562 209.304688 " fill-opacity="1" fill-rule="evenodd"/></g><path fill="#000000" d="M 331.914062 209.304688 C 348.394531 209.304688 361.753906 195.9375 361.753906 179.457031 C 361.753906 162.976562 348.394531 149.609375 331.914062 149.609375 Z M 331.914062 209.304688 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 146.398438 143.734375 C 153.695312 143.734375 159.667969 149.707031 159.667969 157.003906 L 159.667969 197.179688 C 159.667969 204.476562 153.695312 210.441406 146.398438 210.441406 C 139.101562 210.441406 133.128906 204.476562 133.128906 197.179688 L 133.128906 157.003906 C 133.128906 149.707031 139.101562 143.734375 146.398438 143.734375 Z M 146.398438 143.734375 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 228.191406 143.734375 L 228.199219 143.734375 C 235.496094 143.734375 241.46875 149.707031 241.46875 157.003906 L 241.46875 197.179688 C 241.46875 204.476562 235.496094 210.441406 228.199219 210.441406 L 228.191406 210.441406 C 220.894531 210.441406 214.929688 204.476562 214.929688 197.179688 L 214.929688 157.003906 C 214.929688 149.707031 220.894531 143.734375 228.191406 143.734375 Z M 228.191406 143.734375 " fill-opacity="1" fill-rule="evenodd"/></svg>

    """
  end
  def icons_bot_2(assigns) do
    ~H"""
      <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_bot_2
      #{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} stroke-width="1.5" viewBox="0 0 24 24" stroke="currentColor" zoomAndPan="magnify" viewBox="0 0 375 374.999991" preserveAspectRatio="xMidYMid meet" version="1.0"><defs><clipPath id="a134cb4958"><path d="M 51 141 L 323 141 L 323 364.84375 L 51 364.84375 Z M 51 141 " clip-rule="nonzero"/></clipPath><clipPath id="7f8ec6d8e2"><path d="M 2.945312 199 L 64 199 L 64 307 L 2.945312 307 Z M 2.945312 199 " clip-rule="nonzero"/></clipPath><clipPath id="039237c620"><path d="M 311 199 L 371.945312 199 L 371.945312 307 L 311 307 Z M 311 199 " clip-rule="nonzero"/></clipPath><clipPath id="d3c23d173d"><path d="M 146 10.09375 L 367 10.09375 L 367 217 L 146 217 Z M 146 10.09375 " clip-rule="nonzero"/></clipPath></defs><g clip-path="url(#a134cb4958)"><path fill="#000000" d="M 263.199219 364.773438 L 111.691406 364.773438 C 78.726562 364.773438 51.910156 337.953125 51.910156 304.984375 L 51.910156 201.15625 C 51.910156 168.1875 78.726562 141.363281 111.691406 141.363281 L 153.25 141.363281 C 155.910156 141.363281 158.226562 143.183594 158.851562 145.769531 C 161.140625 155.195312 169.824219 162.039062 179.5 162.039062 L 195.65625 162.039062 C 197.1875 162.039062 198.652344 162.644531 199.734375 163.730469 C 200.8125 164.8125 201.421875 166.277344 201.421875 167.808594 L 201.414062 198.105469 L 244.113281 163.332031 C 245.140625 162.496094 246.429688 162.039062 247.753906 162.039062 L 305.621094 162.039062 C 307.386719 162.039062 309.054688 162.847656 310.148438 164.230469 C 318.546875 174.875 322.984375 187.644531 322.984375 201.152344 L 322.984375 304.980469 C 322.984375 337.953125 296.164062 364.773438 263.199219 364.773438 Z M 111.691406 152.902344 C 85.085938 152.902344 63.441406 174.546875 63.441406 201.15625 L 63.441406 304.984375 C 63.441406 331.59375 85.082031 353.242188 111.691406 353.242188 L 263.199219 353.242188 C 289.804688 353.242188 311.453125 331.59375 311.453125 304.984375 L 311.453125 201.15625 C 311.453125 191.179688 308.441406 181.699219 302.730469 173.570312 L 249.804688 173.570312 L 199.28125 214.714844 C 197.554688 216.121094 195.175781 216.398438 193.167969 215.449219 C 191.152344 214.496094 189.875 212.464844 189.875 210.238281 L 189.886719 173.574219 L 179.5 173.574219 C 165.886719 173.574219 153.945312 165.269531 149.046875 152.902344 Z M 111.691406 152.902344 " fill-opacity="1" fill-rule="evenodd"/></g><g clip-path="url(#7f8ec6d8e2)"><path fill="#000000" d="M 57.675781 306.53125 L 35.726562 306.53125 C 17.652344 306.53125 2.953125 291.828125 2.953125 273.753906 L 2.953125 232.390625 C 2.953125 214.3125 17.652344 199.609375 35.726562 199.609375 L 57.675781 199.609375 C 60.859375 199.609375 63.4375 202.191406 63.4375 205.378906 L 63.4375 300.769531 C 63.4375 303.953125 60.859375 306.53125 57.675781 306.53125 Z M 35.730469 211.144531 C 24.015625 211.144531 14.484375 220.675781 14.484375 232.390625 L 14.484375 273.753906 C 14.484375 285.46875 24.015625 295 35.730469 295 L 51.910156 295 L 51.910156 211.144531 Z M 35.730469 211.144531 " fill-opacity="1" fill-rule="evenodd"/></g><g clip-path="url(#039237c620)"><path fill="#000000" d="M 339.160156 306.53125 L 317.214844 306.53125 C 314.027344 306.53125 311.449219 303.953125 311.449219 300.765625 L 311.449219 205.378906 C 311.449219 202.191406 314.027344 199.609375 317.214844 199.609375 L 339.160156 199.609375 C 357.234375 199.609375 371.9375 214.3125 371.9375 232.390625 L 371.9375 273.753906 C 371.9375 291.828125 357.234375 306.53125 339.160156 306.53125 Z M 322.984375 295 L 339.164062 295 C 350.878906 295 360.410156 285.46875 360.410156 273.753906 L 360.410156 232.390625 C 360.410156 220.675781 350.878906 211.144531 339.164062 211.144531 L 322.984375 211.144531 Z M 322.984375 295 " fill-opacity="1" fill-rule="evenodd"/></g><path fill="#000000" d="M 133.429688 250.152344 C 130.242188 250.152344 127.664062 247.570312 127.664062 244.386719 L 127.664062 217.484375 C 127.664062 214.296875 130.242188 211.71875 133.429688 211.71875 C 136.613281 211.71875 139.195312 214.296875 139.195312 217.484375 L 139.195312 244.386719 C 139.195312 247.570312 136.609375 250.152344 133.429688 250.152344 Z M 133.429688 250.152344 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 241.460938 249.984375 C 238.277344 249.984375 235.699219 247.40625 235.699219 244.21875 L 235.699219 217.648438 C 235.699219 214.460938 238.277344 211.882812 241.460938 211.882812 C 244.648438 211.882812 247.226562 214.460938 247.226562 217.648438 L 247.226562 244.222656 C 247.226562 247.40625 244.648438 249.984375 241.460938 249.984375 Z M 241.460938 249.984375 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 215.71875 294.425781 L 159.171875 294.425781 C 155.984375 294.425781 153.40625 291.84375 153.40625 288.65625 C 153.40625 285.472656 155.984375 282.890625 159.171875 282.890625 L 215.71875 282.890625 C 218.90625 282.890625 221.484375 285.472656 221.484375 288.65625 C 221.484375 291.84375 218.90625 294.425781 215.71875 294.425781 Z M 215.71875 294.425781 " fill-opacity="1" fill-rule="evenodd"/><g clip-path="url(#d3c23d173d)"><path fill="#000000" d="M 195.640625 216.007812 C 194.796875 216.007812 193.953125 215.820312 193.164062 215.449219 C 191.152344 214.496094 189.875 212.464844 189.875 210.238281 L 189.886719 173.574219 L 179.5 173.574219 C 161.429688 173.574219 146.726562 158.871094 146.726562 140.792969 L 146.726562 42.875 C 146.726562 24.796875 161.429688 10.09375 179.5 10.09375 L 333.960938 10.09375 C 352.035156 10.09375 366.734375 24.796875 366.734375 42.871094 L 366.734375 140.792969 C 366.734375 158.871094 352.03125 173.574219 333.960938 173.574219 L 249.804688 173.574219 L 199.28125 214.714844 C 198.234375 215.566406 196.945312 216.007812 195.640625 216.007812 Z M 179.5 21.625 C 167.785156 21.625 158.257812 31.15625 158.257812 42.871094 L 158.257812 140.792969 C 158.257812 152.507812 167.785156 162.039062 179.5 162.039062 L 195.65625 162.042969 C 197.1875 162.042969 198.652344 162.648438 199.730469 163.734375 C 200.8125 164.816406 201.421875 166.28125 201.421875 167.8125 L 201.410156 198.109375 L 244.113281 163.335938 C 245.140625 162.5 246.429688 162.042969 247.753906 162.042969 L 333.960938 162.042969 C 345.671875 162.042969 355.203125 152.507812 355.203125 140.796875 L 355.203125 42.875 C 355.203125 31.160156 345.671875 21.628906 333.960938 21.628906 Z M 179.5 21.625 " fill-opacity="1" fill-rule="evenodd"/></g><path fill="#000000" d="M 201.445312 112.796875 C 189.886719 112.796875 180.488281 103.394531 180.488281 91.835938 C 180.488281 80.277344 189.890625 70.878906 201.445312 70.878906 C 213 70.878906 222.402344 80.28125 222.402344 91.835938 C 222.40625 103.394531 213.003906 112.796875 201.445312 112.796875 Z M 201.445312 82.40625 C 196.246094 82.40625 192.015625 86.636719 192.015625 91.835938 C 192.015625 97.035156 196.242188 101.261719 201.445312 101.261719 C 206.644531 101.261719 210.875 97.035156 210.875 91.835938 C 210.875 86.636719 206.644531 82.40625 201.445312 82.40625 Z M 201.445312 82.40625 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 256.730469 112.796875 C 245.171875 112.796875 235.773438 103.394531 235.773438 91.835938 C 235.773438 80.277344 245.175781 70.878906 256.730469 70.878906 C 268.28125 70.878906 277.683594 80.28125 277.683594 91.835938 C 277.6875 103.394531 268.285156 112.796875 256.730469 112.796875 Z M 256.730469 82.40625 C 251.53125 82.40625 247.300781 86.636719 247.300781 91.835938 C 247.300781 97.035156 251.527344 101.261719 256.730469 101.261719 C 261.929688 101.261719 266.15625 97.035156 266.15625 91.835938 C 266.15625 86.636719 261.929688 82.40625 256.730469 82.40625 Z M 256.730469 82.40625 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 312.015625 112.796875 C 300.457031 112.796875 291.058594 103.394531 291.058594 91.835938 C 291.058594 80.277344 300.460938 70.878906 312.015625 70.878906 C 323.566406 70.878906 332.96875 80.28125 332.96875 91.835938 C 332.972656 103.394531 323.570312 112.796875 312.015625 112.796875 Z M 312.015625 82.40625 C 306.816406 82.40625 302.585938 86.636719 302.585938 91.835938 C 302.585938 97.035156 306.8125 101.261719 312.015625 101.261719 C 317.214844 101.261719 321.441406 97.035156 321.441406 91.835938 C 321.441406 86.636719 317.214844 82.40625 312.015625 82.40625 Z M 312.015625 82.40625 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 35.730469 211.144531 C 32.542969 211.144531 29.964844 208.5625 29.964844 205.378906 L 29.964844 128.6875 C 29.964844 125.503906 32.542969 122.921875 35.730469 122.921875 C 38.914062 122.921875 41.496094 125.503906 41.496094 128.6875 L 41.496094 205.378906 C 41.496094 208.5625 38.914062 211.144531 35.730469 211.144531 Z M 35.730469 211.144531 " fill-opacity="1" fill-rule="evenodd"/><path fill="#000000" d="M 35.730469 134.453125 C 19.34375 134.453125 6.015625 121.125 6.015625 104.734375 C 6.015625 88.347656 19.34375 75.015625 35.730469 75.015625 C 52.117188 75.015625 65.445312 88.347656 65.445312 104.734375 C 65.445312 121.125 52.113281 134.453125 35.730469 134.453125 Z M 35.730469 86.550781 C 25.703125 86.550781 17.542969 94.710938 17.542969 104.738281 C 17.542969 114.765625 25.703125 122.925781 35.730469 122.925781 C 45.753906 122.925781 53.914062 114.765625 53.914062 104.738281 C 53.914062 94.710938 45.757812 86.550781 35.730469 86.550781 Z M 35.730469 86.550781 " fill-opacity="1" fill-rule="evenodd"/></svg>
