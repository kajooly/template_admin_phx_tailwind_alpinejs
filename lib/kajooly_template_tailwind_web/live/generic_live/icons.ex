defmodule KajoolyTemplateTailwindWeb.GenericLive.Icons do
  ...
  def icons_search(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_search#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"currentColor"} class={"bi bi-search #{assigns[:class]}"} viewBox="0 0 16 16">
  ...
  def icons_plus(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" id={assigns[:id]||"icons_plus#{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"currentColor"} class={"bi bi-plus #{assigns[:class]}"} viewBox="0 0 16 16">
  ...
  def icons_bot_1(assigns) do
    ~H"""
      ...
      <svg id={assigns[:id]||"icons_bot_1
      #{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" stroke="currentColor">
      <!-- Generated by Pixelmator Pro 2.1.3 -->
      <g id="2">
        <g id="group">
        <path id="Trazado" d="M22.57 31.269 L9.43 31.269 C6.571 31.269 4.246 28.943 4.246 26.084 L4.246 17.079 C4.246 14.22 6.571 11.894 9.43 11.894 L13.034 11.894 C13.265 11.894 13.466 12.052 13.52 12.276 13.719 13.093 14.472 13.687 15.311 13.687 L16.712 13.687 C16.845 13.687 16.972 13.739 17.066 13.834 17.159 13.927 17.212 14.054 17.212 14.187 L17.211 16.815 20.915 13.799 C21.004 13.727 21.115 13.687 21.23 13.687 L26.249 13.687 C26.402 13.687 26.547 13.757 26.641 13.877 27.37 14.8 27.755 15.908 27.755 17.079 L27.755 26.083 C27.755 28.943 25.429 31.269 22.57 31.269 Z M9.43 12.895 C7.123 12.895 5.246 14.772 5.246 17.079 L5.246 26.084 C5.246 28.391 7.123 30.269 9.43 30.269 L22.57 30.269 C24.877 30.269 26.755 28.391 26.755 26.084 L26.755 17.079 C26.755 16.214 26.493 15.392 25.998 14.687 L21.408 14.687 17.026 18.255 C16.877 18.377 16.67 18.401 16.496 18.319 16.321 18.236 16.211 18.06 16.211 17.867 L16.212 14.687 15.311 14.687 C14.13 14.687 13.095 13.967 12.67 12.895 Z M9.43 12.895" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        </g>
        <g id="group-1">
        <path id="Trazado-1" d="M4.746 26.218 L2.842 26.218 C1.275 26.218 -0 24.943 -0 23.375 L-0 19.788 C-0 18.22 1.275 16.945 2.842 16.945 L4.746 16.945 C5.022 16.945 5.245 17.169 5.245 17.446 L5.245 25.718 C5.245 25.994 5.022 26.218 4.746 26.218 Z M2.843 17.946 C1.827 17.946 1 18.772 1 19.788 L1 23.375 C1 24.391 1.827 25.218 2.843 25.218 L4.246 25.218 4.246 17.946 Z M2.843 17.946" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        </g>
        <g id="group-2">
        <path id="Trazado-2" d="M29.157 26.218 L27.254 26.218 C26.978 26.218 26.754 25.994 26.754 25.718 L26.754 17.446 C26.754 17.169 26.978 16.945 27.254 16.945 L29.157 16.945 C30.725 16.945 32 18.22 32 19.788 L32 23.375 C32 24.943 30.725 26.218 29.157 26.218 Z M27.755 25.218 L29.158 25.218 C30.174 25.218 31 24.391 31 23.375 L31 19.788 C31 18.772 30.174 17.946 29.158 17.946 L27.755 17.946 Z M27.755 25.218" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        </g>
        <path id="Trazado-3" d="M11.316 21.328 C11.039 21.328 10.815 21.105 10.815 20.828 L10.815 18.495 C10.815 18.219 11.039 17.995 11.316 17.995 11.592 17.995 11.816 18.219 11.816 18.495 L11.816 20.828 C11.816 21.105 11.591 21.328 11.316 21.328 Z M11.316 21.328" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        <path id="Trazado-4" d="M20.684 21.314 C20.408 21.314 20.185 21.09 20.185 20.814 L20.185 18.51 C20.185 18.233 20.408 18.01 20.684 18.01 20.961 18.01 21.185 18.233 21.185 18.51 L21.185 20.814 C21.185 21.09 20.961 21.314 20.684 21.314 Z M20.684 21.314" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        <path id="Trazado-5" d="M18.452 25.168 L13.548 25.168 C13.272 25.168 13.048 24.944 13.048 24.668 13.048 24.392 13.272 24.168 13.548 24.168 L18.452 24.168 C18.728 24.168 18.952 24.392 18.952 24.668 18.952 24.944 18.728 25.168 18.452 25.168 Z M18.452 25.168" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        <g id="group-3">
        <path id="Trazado-6" d="M16.711 18.367 C16.638 18.367 16.564 18.351 16.496 18.319 16.321 18.236 16.211 18.06 16.211 17.867 L16.212 14.687 15.311 14.687 C13.744 14.687 12.469 13.412 12.469 11.844 L12.469 3.352 C12.469 1.785 13.744 0.51 15.311 0.51 L28.707 0.51 C30.274 0.51 31.549 1.785 31.549 3.352 L31.549 11.844 C31.549 13.412 30.274 14.687 28.707 14.687 L21.408 14.687 17.026 18.255 C16.936 18.329 16.824 18.367 16.711 18.367 Z M15.311 1.51 C14.295 1.51 13.469 2.336 13.469 3.352 L13.469 11.844 C13.469 12.86 14.295 13.687 15.311 13.687 L16.712 13.687 C16.845 13.687 16.972 13.74 17.065 13.834 17.159 13.928 17.212 14.055 17.212 14.188 L17.211 16.815 20.915 13.799 C21.004 13.727 21.115 13.687 21.23 13.687 L28.707 13.687 C29.722 13.687 30.549 12.86 30.549 11.845 L30.549 3.352 C30.549 2.337 29.722 1.51 28.707 1.51 Z M15.311 1.51" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        </g>
        <path id="Trazado-7" d="M17.214 9.416 C16.212 9.416 15.397 8.601 15.397 7.599 15.397 6.596 16.212 5.781 17.214 5.781 18.216 5.781 19.032 6.597 19.032 7.599 19.032 8.601 18.217 9.416 17.214 9.416 Z M17.214 6.781 C16.763 6.781 16.396 7.148 16.396 7.599 16.396 8.049 16.763 8.416 17.214 8.416 17.665 8.416 18.032 8.049 18.032 7.599 18.032 7.148 17.665 6.781 17.214 6.781 Z M17.214 6.781" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        <path id="Trazado-8" d="M22.009 9.416 C21.006 9.416 20.191 8.601 20.191 7.599 20.191 6.596 21.007 5.781 22.009 5.781 23.01 5.781 23.826 6.597 23.826 7.599 23.826 8.601 23.011 9.416 22.009 9.416 Z M22.009 6.781 C21.558 6.781 21.191 7.148 21.191 7.599 21.191 8.049 21.557 8.416 22.009 8.416 22.46 8.416 22.826 8.049 22.826 7.599 22.826 7.148 22.46 6.781 22.009 6.781 Z M22.009 6.781" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        <path id="Trazado-9" d="M26.803 9.416 C25.801 9.416 24.986 8.601 24.986 7.599 24.986 6.596 25.801 5.781 26.803 5.781 27.805 5.781 28.62 6.597 28.62 7.599 28.621 8.601 27.805 9.416 26.803 9.416 Z M26.803 6.781 C26.352 6.781 25.986 7.148 25.986 7.599 25.986 8.049 26.352 8.416 26.803 8.416 27.254 8.416 27.621 8.049 27.621 7.599 27.621 7.148 27.254 6.781 26.803 6.781 Z M26.803 6.781" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        <path id="Trazado-10" d="M2.843 17.946 C2.566 17.946 2.343 17.722 2.343 17.446 L2.343 10.795 C2.343 10.518 2.566 10.294 2.843 10.294 3.119 10.294 3.343 10.518 3.343 10.795 L3.343 17.446 C3.343 17.722 3.119 17.946 2.843 17.946 Z M2.843 17.946" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        <path id="Trazado-11" d="M2.843 11.295 C1.421 11.295 0.266 10.139 0.266 8.717 0.266 7.296 1.421 6.14 2.843 6.14 4.264 6.14 5.42 7.296 5.42 8.717 5.42 10.139 4.263 11.295 2.843 11.295 Z M2.843 7.14 C1.973 7.14 1.265 7.848 1.265 8.718 1.265 9.587 1.973 10.295 2.843 10.295 3.712 10.295 4.42 9.587 4.42 8.718 4.42 7.848 3.712 7.14 2.843 7.14 Z M2.843 7.14" fill="#000000" fill-opacity="1" stroke="currentColor"/>
      </g>
      </svg>
  ...
  def icons_bot_2(assigns) do
    ~H"""
      <svg id={assigns[:id]||"icons_bot_2
      #{gen_id_key()}"} width={assigns[:width]||"16"} height={assigns[:height]||"16"} fill={assigns[:fill]||"none"}  class={" #{assigns[:class]}"} stroke-width="1.5" stroke="currentColor"  viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
        <!-- Generated by Pixelmator Pro 2.1.3 -->
        <g id="1">
          <path id="Trazado" d="M11.343 7.446 L20.62 7.446 C23.17 7.446 25.487 8.489 27.168 10.168 28.846 11.847 29.89 14.166 29.89 16.716 29.89 19.266 28.846 21.584 27.168 23.264 25.487 24.943 23.17 25.986 20.62 25.986 L19.607 25.986 14.46 30.782 C13.995 31.214 13.267 31.188 12.834 30.724 12.628 30.502 12.526 30.22 12.526 29.94 L12.524 29.94 12.524 25.986 11.343 25.986 C8.792 25.986 6.475 24.943 4.795 23.264 3.115 21.584 2.073 19.266 2.073 16.716 2.073 14.166 3.115 11.847 4.795 10.168 6.475 8.489 8.792 7.446 11.343 7.446 Z M20.62 9.752 L11.343 9.752 C9.429 9.752 7.688 10.536 6.425 11.799 5.162 13.061 4.379 14.802 4.379 16.716 4.379 18.63 5.162 20.371 6.425 21.633 7.688 22.896 9.429 23.68 11.343 23.68 L13.676 23.68 C14.313 23.68 14.829 24.196 14.829 24.833 L14.829 27.293 18.316 24.042 C18.527 23.82 18.825 23.68 19.157 23.68 L20.62 23.68 C22.533 23.68 24.274 22.896 25.537 21.633 26.799 20.371 27.583 18.63 27.583 16.716 27.583 14.802 26.799 13.061 25.537 11.799 24.274 10.536 22.533 9.752 20.62 9.752 Z M20.62 9.752" fill="#000000" fill-opacity="1" stroke="currentColor"/>
          <path id="Trazado-1" d="M15.198 3.961 L16.765 3.961 16.765 8.717 15.198 8.717 Z M15.198 3.961" fill="#000000" fill-opacity="1" stroke="currentColor"/>
          <path id="Trazado-2" d="M15.981 1.799 C17.115 1.799 18.035 2.719 18.035 3.853 18.035 4.987 17.115 5.907 15.981 5.907 14.847 5.907 13.927 4.987 13.927 3.853 13.927 2.719 14.847 1.799 15.981 1.799 Z M15.981 1.799" fill="#000000" fill-opacity="1" stroke="currentColor"/>
          <g id="group">
          <path id="Trazado-3" d="M2.741 19.457 C1.227 19.457 0 18.229 0 16.716 0 15.203 1.227 13.975 2.741 13.975 Z M2.741 19.457" fill="#000000" fill-opacity="1" stroke="currentColor"/>
          </g>
          <path id="Trazado-4" d="M29.26 19.457 C30.773 19.457 32 18.229 32 16.716 32 15.203 30.773 13.975 29.26 13.975 Z M29.26 19.457" fill="#000000" fill-opacity="1" stroke="currentColor"/>
          <path id="Trazado-5" d="M12.226 13.436 C12.896 13.436 13.444 13.984 13.444 14.654 L13.444 18.343 C13.444 19.013 12.896 19.561 12.226 19.561 11.556 19.561 11.007 19.013 11.007 18.343 L11.007 14.654 C11.007 13.984 11.556 13.436 12.226 13.436 Z M12.226 13.436" fill="#000000" fill-opacity="1" stroke="currentColor"/>
          <path id="Trazado-6" d="M19.736 13.436 L19.737 13.436 C20.407 13.436 20.955 13.984 20.955 14.654 L20.955 18.343 C20.955 19.013 20.407 19.561 19.737 19.561 L19.736 19.561 C19.066 19.561 18.518 19.013 18.518 18.343 L18.518 14.654 C18.518 13.984 19.066 13.436 19.736 13.436 Z M19.736 13.436" fill="#000000" fill-opacity="1" stroke="currentColor"/>
        </g>
        </svg>
